...
class Fonts():
    def __init__(self,nplayers,controle, window):
        #self.tam = 60*1368
        self.window = window
        self.font1 = pygame.font.Font("fonts/fonte.ttf",60)
        self.menu_font = pygame.font.Font("fonts/menu_font.ttf",90)
        self.menu_font2 = pygame.font.Font("fonts/menu_font.ttf",120)
        self.menu_options_target = [ self.menu_font2.render('New Game', True, (255,0,0)),
                                     self.menu_font2.render('Options', True, (0,255,0)),
                                     self.menu_font2.render('Quit', True, (0,0,255))]

        self.menu_options = [ self.menu_font.render('New Game', True, (255,0,0)),
                              self.menu_font.render('Options', True, (0,255,0)),
                              self.menu_font.render('Quit', True, (0,0,255))]
